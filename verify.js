...
for (const f of pages) {
  ...
  if (f === 'reserve.html') {
    ...
    // STORES本番URL: おひとり参加(相席)3帯のみ。会をつくる/コーチ/セット/CAMPのサイト導線はv21で廃止
    ...
    checks.push([!/aiseki_create|\bcoach:|\bset:|\bcamp:/.test(html), '廃止済みSTORESキー(aiseki_create/coach/set/camp)が残存(v21で廃止)']);
